...
from apps.inventario.models import MotivoBaja
from apps.catalogo.models import CategoriaProducto, UnidadMedida
from apps.seguridad.models import Permiso, Rol, Usuario
...
PERMISOS = {
    ...
    "catalogo.gestionar": "Gestionar categorias y unidades",
    ...
    "importacion.gestionar": "Importar datos historicos",
...
ROLES = {
    ...
    "Encargado/a de Farmacia": [
        ...
        "catalogo.gestionar", "proveedores.crear", "proveedores.editar",
        ...
        "kardex.ver", "reportes.ver", "importacion.gestionar",
